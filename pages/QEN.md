...
suggestions over the holidays.

If like me, you're still hanging on to an un-upgradeable Windows
10 computer, we'll have to talk about alternative operating
systems. Linux (I prefer Linux Mint XFCE) runs great, especially
on old hardware, and the OS and software have become even easier
to learn for people coming from Windows.

In addition to operating systems, we'll look at office packages, password
managers, desktop publishing software, PDF document tools,
statistical software, mechanical and electronics CAD, graphics
editing, and programming IDEs. Please come ready with your own
...
History of Innovation. Throughout my career I was lucky to work
around creative people in creative environments. In my years at GE
we had some training in how the company tried to foster creativity
and innovation among its scientists and engineers; however, I
never really understood how that process works. Johnson's book
helped to identify some of the pieces and I plan to read it a
second time to make sure I understand as much as Johnson offers.
We'll talk about Where Good Ideas Come From at this month's
...
#### Acceptance Sampling for Defectives with ANSI/ASQ Z1.4 and Squeglia's *Zero Acceptance Number Sampling Plans*: What Do You Get?, 12 September 2025, 7:30-9:00AM, by Zoom  
...
archaic relative to the sampling plan design tools that are
available today. Both of those standards are indexed by AQL and
lot size; however, what sampling plan performance do they actually
deliver and how might we do better? At this month's QMN meeting
we'll review how to choose a sampling plan from one of these
standards, how the sampling plan parameters (sample size and
acceptance number) are determined, and how to characterize the
performance of the sampling plan using an operating characteristic
curve.
<br> <br>  
  
#### Book Review: Wayne Taylor, Statistical Procedures for the Medical Device Industry, 8 August 2025, 7:30-9:00AM, by Zoom  
...
regulatory standards, and on-line sources. Even after culling my
own library of reference materials I still have over 100 textbooks
that I can't part with. There are a few books that stand out, like
Nancy Tague's *The Quality Toolbox*, *Juran's Quality
Control Handbook*, Doug Montgomery's *Statistical Quality
Control*, and others. (Ask me for a recommendation if there's
a specific topic that you're interested in.) One of the very
impressive recent additions that I highly recommend is Wayne
Taylor's *Statistical Procedures for the Medical Device
Industry*. Even though the title of the book calls out the
medical device field the material in the book is of general
interest with coverage of acceptance sampling, SPC, designed
experiments, reliability, etc. The book is not cheap - it's about
$300 for the hard-copy and/or e-copy - but considering its content
it's a wise investment. When I purchased the book I bought it in
both hard- and e-copies so for this month's QEN meeting I'll lead
you through my e-copy so you can see what the book provides. You
can learn more about the book [here](https://variation.com/product/statistical-procedures-for-the-medical-device-industry/).

I don't mean this QEN session to be an in-depth investigation into
any of the methods in Taylor's book. My general intent for QEN is
to stick to more basic topics and leave the more advanced topics
to QMN; however, someone getting started in quality engineering
statistics and quality engineering or just trying to fill the gaps
in their knowledge would be wise to consider investing in this
...
ones are interchangeable and which ones are different. One such
collection of methods is statistical intervals including
confidence intervals, prediction intervals, and tolerance
intervals. At this month's QEN meeting we'll discuss the
calculation, use, and interpretation of each type of statistical
interval. If you have any examples or data that you would like to
...
customers who was in this situation. He was trying to support one
of his suppliers to solve a quality problem and the supplier was
naive of the methods that were required. My customer was
frustrated at the schedule delays and the push-back he was
receiving from his supplier - who was effectively resisting his
recommendations to resolve the problem. As we were discussing
available strategies for him to deal with his customer, I realized
I was invoking methods I learned in a GE course long ago. The
impact of that training on me was profound and I subconsciously
use the methods I learned when dealing with pretty much everyone
including my customers, bosses, coworkers, and students.
...
effective. To answer that question, they had to characterize
leader and follower behaviors. In the simplest implementation of
their system, they created a two-dimensional model for leaders
based on 1) task-oriented behavior and 2) relationship-oriented
behavior. For the followers they created a two-dimensional model
based on 1) ability and 2) motivation. When they collected data
studying the relationship between leader and follower behaviors
they were able to identify an optimal (in terms of overall leader
and follower system performance) leadership strategy for managers.
Many of the stories that I tell in classes and at meetings come
...
the effect of attempting to control a process when it is only
subject to random/common cause variation. The experiment can be
done with Deming's original hardware (a funnel supported by a ring
stand and marbles), by dropping playing cards, or by computer
simulation. We're meeting remotely so we'll do this by computer
...
Distribution Identification** method which fits 16 different
distribution models to your data, including the Box-Cox and
...
distribution fitting tools are, I think their use reeks of
desperation and most often leads to a one-time solution that will
probably betray you in the future. At this month's QEN meeting
we'll look at some purposely (via simulation) problematic data
sets to see what distribution models fit and if there was any
...
#### Applications of ChatGPT in Manufacturing Quality Engineering, 13 September, 7:30-9:00AM, by Zoom
...
#### Assessing Agreement Between Two Measurement Systems with the Bland-Altman Method, 9 June 2023, 7:30-9:00AM, by Zoom  
...
#### se Expectation Value to Evaluate and Compare Business Process Models, 7:30-9:00AM, 12 August 2022, by Zoom.**  
...
#### Misuse of Two-Sample T Tests To Analyze Two-way and Multi-way Classification Designs, 8 April 2022, 7:30-9:00AM, by Zoom  
...
#### Use Operating Characteristic (OC) Curves to Interpret Sampling Plan Performance, 7:30-9:00AM, 11 March 2022, by Zoom  
...
#### Extending the Two-Level Factorial Designs to Fractional Factorial and Response Surface Designs, 7:30-9:00AM, 14 January 2022, by Zoom  
...
#### SQ Certification, 7:30-9:00AM, 15 January 2021, by Zoom  
